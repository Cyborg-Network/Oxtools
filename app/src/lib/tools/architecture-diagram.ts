  ...
  inputs: [
    {
      ...
      type: "textarea",
      placeholder: "A microservices e-commerce platform with user service, product catalog, shopping cart, payment processing via Stripe, and a notification service that sends emails and push notifications...",
      rows: 6,
    },
    {
      key: "diagramType",
