...
export const codeSecurityScannerV2: ToolDefinition = {
	...
	description:
		"Advanced multi-file security scanner: cross-file taint tracking, import chain analysis, obfuscation decoding, dependency CVE checks + LLM deep audit.",
	category: "developer",
	icon: "Shield",
	status: "active",
	tier: "tier2",
	...
	inputs: [
		{
			...
			maxSizeMb: 10,
			helperText:
				"Upload multiple files from your project or a ZIP archive. The scanner will analyze cross-file dependencies, imports, and taint flow. Languages are auto-detected from file extensions.",
		},
		{
			key: "code",
