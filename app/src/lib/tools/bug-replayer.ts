  ...
  inputs: [
    {
      ...
      type: "textarea",
      placeholder: "E.g. 'The /api/users endpoint returns 500 when the email contains a + sign. Works fine with normal emails. Started after we upgraded the validation library.'",
      rows: 5,
    },
    {
      key: "errorOutput",
