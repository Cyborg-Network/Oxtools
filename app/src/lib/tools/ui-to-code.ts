  ...
  inputs: [
    {
      ...
      type: "textarea",
      placeholder: "E.g. 'A pricing card with 3 tiers (Free, Pro, Enterprise). Each card shows the plan name, price, a list of features with check/cross icons, and a CTA button. The Pro tier should be highlighted as \"Most Popular\".'",
      rows: 6,
    },
    {
      key: "framework",
