    ...
    <div className="p-6 space-y-10">
      ...
      <div className="relative overflow-hidden rounded-xl border border-border bg-card p-6 sm:p-8">
        ...
        <div className="relative">
          ...
          <h1 className="mt-3 text-2xl font-bold tracking-tight text-foreground sm:text-3xl" style={{ fontFamily: "var(--font-unbounded), sans-serif" }}>
            Welcome to Oxtools
          </h1>
          <p className="mt-2 max-w-lg text-[14px] text-muted-foreground leading-relaxed">
            ...
            <a href="https://oxlo.ai" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline underline-offset-2 font-medium">
              Oxlo.ai
            </a>
            {" "}community. Pick a tool from the sidebar or explore below.
          </p>
          <div className="mt-4 flex gap-3">
            <a href="https://github.com/Cyborg-Network/Oxtools" target="_blank" rel="noopener noreferrer">
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          <h2 className="text-lg font-semibold text-foreground" style={{ fontFamily: "var(--font-unbounded), sans-serif" }}>
            Quick Access
          </h2>
            ...
            <Link key={tool.id} href={`/tools/${tool.id}`} className="group block">
              <div className="h-full rounded-xl border border-border bg-card p-4 transition-all duration-300 hover:border-primary/40 hover:shadow-lg hover:shadow-primary/5 relative">
                ...
                <div className="flex items-center gap-2.5 mb-2">
                  ...
                  <span className="text-[14px] font-semibold text-foreground truncate" style={{ fontFamily: "var(--font-unbounded), sans-serif" }}>
                    {tool.name}
                  </span>
                </div>
        ...
        {activeTools.length > 8 && (
          <div className="text-center">
            <a href="#all-tools" className="inline-flex items-center gap-1 text-[13px] font-medium text-primary hover:gap-2 transition-all">
            ...
            return (
              <section key={categoryKey} id={categoryKey} className="space-y-4 pt-4 scroll-mt-20">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="text-[15px] font-semibold text-foreground" style={{ fontFamily: "var(--font-unbounded), sans-serif" }}>
                      {categoryInfo.name}
                    </h3>
