...
export function ColorPaletteViewer({ data, enableHover = true }: ColorPaletteViewerProps) {
  ...
  const [highlightBox, setHighlightBox] = useState<{ x: number; y: number; size: number } | null>(null);
        ...
        <Card className="border-primary/20 bg-gradient-to-br from-primary/[0.05] to-primary/[0.02] overflow-hidden">
          <CardContent className="p-6">
            ...
            <div ref={wrapperRef} className="relative w-full max-w-2xl mx-auto">
              <div ref={containerRef} className="relative w-full overflow-hidden rounded-lg border border-border/50 shadow-lg">
                <canvas
                  ref={canvasRef}
